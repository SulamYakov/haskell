...
--[><] Problem 6: Determine whether or not a list is a palindrome.
...
--[><] Problem 8: Compress a list by removing repeating elements.
...
--[><] Problem 10: Encode the run-length of consecutive duplicates in a list.
...
--[><] Problem 11: Modify the result of problem 10 to send only non-singular elements as tuples, and singular elements as themselves. 
...
--[><] Problem 12: Create a function that decodes lists of compressed strings, as generated by Problem 11. In other words,
...
--[><] Problem 13: Implement run-length data encoding directly, without packing consecutive elements into sublists.
...
--[><] Problem 18: Slice a list. Given two indices, i and k, the slice is the list containing the elements 
...
--[><] Problem 19: Rotate a list about a pivot N.
...
--[><] Problem 22: Create a list that contains all integers within a given range, inclusive.

--obvious, reliant on Prelude solution
myRange :: Int -> Int -> [Int]
myRange a b 
    | a == b = [a]
    | a <  b = [a..b]
...
--tail-recursive solution, not reliant on '++'
--to-be-made

--[ ] Problem 23: Extract a given number of randomly selected elements from a given list.

myRandExtract :: [a] -> Int -> [a]
